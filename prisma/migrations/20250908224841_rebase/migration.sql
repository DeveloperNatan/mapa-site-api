...
*/
-- DropIndex
DROP INDEX "RelacionamentoPA_LocalCompleto_key";

-- AlterTable
ALTER TABLE "LocalizacaoPA" DROP COLUMN "Andar",
...
-- AlterTable
ALTER TABLE "RelacionamentoPA" DROP COLUMN "DataCricao",
...
-- AddForeignKey
ALTER TABLE "HistoricoPA" ADD CONSTRAINT "HistoricoPA_localizacaoPAId_fkey" FOREIGN KEY ("localizacaoPAId") REFERENCES "LocalizacaoPA"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HistoricoPA" ADD CONSTRAINT "HistoricoPA_relacionamentoPAId_fkey" FOREIGN KEY ("relacionamentoPAId") REFERENCES "RelacionamentoPA"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
